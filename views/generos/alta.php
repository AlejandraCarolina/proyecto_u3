...
<body>
    ...
    <div class="form-container">
        <h2 class="text-center">Alta Género</h2>
        <br>
        <!-- Formulario -->
        <form action="./index.php?controller=GenerosController&action=alta" method="POST">
    <!-- Campo de nombre -->
    <div class="form-group">
        <label for="nombre">Nombre del Género:</label>
        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese el nombre del género" required>
    </div>
    <br>
    <!-- Botón de enviar -->
    <button type="submit" class="btn btn-secondary btn-block">Agregar Género</button>
</form>
