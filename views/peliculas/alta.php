...
<body>
    ...
    <div class="form-container">
        <h2 class="text-center">Alta Película</h2>
        <!-- Formulario para dar de alta una película -->
        <form action="index.php?controller=PeliculasController&action=alta" method="POST">
            <div class="form-group">
                <label for="nombre">Nombre:</label>
                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese el nombre de la película" required>
            </div>

            <div class="form-group">
                <label for="duracion">Duración:</label>
                <input type="time" class="form-control" id="duracion" name="duracion" placeholder="Ingrese la duración en minutos" required>
            </div>
            ...
            <div class="form-group">
                ...
                <?php foreach ($generos as $genero): ?>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="gen<?php echo $genero['id_genero']; ?>" name="id_genero[]" value="<?php echo $genero['id_genero']; ?>">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="sinopsis" name="sinopsis" placeholder="Ingrese la sinopsis de la película" rows="4" required></textarea>
            </div>

            <button type="submit" class="btn btn-secondary btn-block">Agregar Película</button>
        </form>
    </div>
